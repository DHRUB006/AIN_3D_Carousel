...
document.onpointerdown = function (e) {
  ...
  e = e || window.event;
  var sX = e.clientX || e.touches[0].clientX,
      sY = e.clientY || e.touches[0].clientY;

  this.onpointermove = function (e) {
    e = e || window.event;
    var nX = e.clientX || e.touches[0].clientX,
...
document.ontouchmove = function(e) {
  if (pinchZoomActive && e.touches.length == 2) {
    ...
    var delta = newDistance - startDistance;
    radius += delta / 10; // Adjust the zoom speed as needed
    init(1);
